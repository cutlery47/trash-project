...
from src.application.core.base_factory import BaseFactory
...
from src.repositories.core.base_exception_handler import BaseExceptionHandler
...
class ApplicationFactory(BaseFactory):
    ...
    def setup_loggers():
        ...
        # file error logger
        logger.add(sink="src/logs/err_logs.json",
                   level="ERROR",
