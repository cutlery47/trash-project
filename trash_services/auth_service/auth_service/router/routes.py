...
def register_auth_routes(router: Router):
    ...
    @router.get("/validate_access_and_id/<int:user_id>")
    ...
    # creates a new user
    def register_user():
        return router.controller.create_user()
